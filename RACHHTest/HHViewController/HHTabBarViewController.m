...
- (void)addChildViewControllerClick
{
    ...
    [self setupChildVc:homevc title:@"首页" image:@"buttn_shi_normal" selectedImage:@"buttn_shi_hover" withItemTag:1];
    HHHomeViewController *audiovc = [[HHHomeViewController alloc]init];
    [self setupChildVc:audiovc title:@"社区" image:@"buttn_she_normal" selectedImage:@"buttn_she_hover" withItemTag:2];
    
    UIViewController *criclevc=[[UIViewController alloc]init];
    [self setupChildVc:criclevc title:@"动态" image:@"tab_dongtai_normal" selectedImage:@"tab_dongtai_select" withItemTag:3];
    UIViewController *mevc=[[UIViewController alloc]init];
    [self setupChildVc:mevc title:@"我的" image:@"buttn_wu_normal" selectedImage:@"buttn_wu_hover" withItemTag:4];
}
/**
 * 初始化子控制器
 */
